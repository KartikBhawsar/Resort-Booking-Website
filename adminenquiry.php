...
$query="select * from stayconnected";
...
<!----------------------------------------------logout button----------------------------------------------->
<a href="http://localhost:8080/tutor/logout.php"title="logout"><img src="https://cdn-icons-png.flaticon.com/128/4436/4436954.png"width="30"height="30"class="logout">
...
<!----------------------------------------------button------------------------------------------------------->
<a href="http://localhost:8080/tutor/websitesettings.php"><button class="button1 button2">Website Settings</button></a>
...
<a href="http://localhost:8080/tutor/adminpanel.php"><button class="button11 button12">Gallery</button></a>
...
?>
    ...
    <td><a href="delete.php?s=$row['sno']"class="btn btn-danger">Delete</td>
  </tr>
<?php
}
?>
